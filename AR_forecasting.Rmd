...
```{r}
str(comparison_df)
comparison_df$Hour <- as.integer(testing$Hour)  # Assuming Hour is included in the testing data
comparison_df$Trip <- factor(comparison_df$Trip)

# Create time series plot
ggplot(comparison_df, aes(x = Hour, y = TOTAL_TRIPS, color = "Actual")) +
  geom_line(aes(y = Actual), linetype = "solid") +
  geom_line(aes(y = Forecasted), linetype = "dashed", color = "blue") +
  labs(x = "Hour", y = "Total Trips", color = "Series") +
  scale_color_manual(values = c("Actual" = "black", "Forecasted" = "blue")) +
  theme_minimal() +
  ggtitle("Actual vs. Forecasted Total Trips") +
...
roc_obj <- roc(comparison_df$Actual, comparison_df$Forecasted)
