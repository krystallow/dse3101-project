...
#fit <- Arima(ts_data_weekday, order=c(2,1,0), seasonal=c(1,0,0), xreg=additional_regressors)
```
...
print(fit) #ARIMA (0,1,1)(0,0,1)

# Fit the model with additional regressors
fit <- Arima(ts_data, order=c(0,1,1), seasonal=c(0,0,1), xreg=additional_regressors)
```
